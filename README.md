...
- [Mục lục](#%EF%B8%8F-m%E1%BB%A5c-l%E1%BB%A5c)
- [Các mảng kiến thức nền tảng](#c%C3%A1c-m%E1%BA%A3ng-ki%E1%BA%BFn-th%E1%BB%A9c-n%E1%BB%81n-t%E1%BA%A3ng)
...
- [Định hướng học tập theo lĩnh vực](#%C4%91%E1%BB%8Bnh-h%C6%B0%E1%BB%9Bng-h%E1%BB%8Dc-t%E1%BA%ADp-theo-l%C4%A9nh-v%E1%BB%B1c)
    - [Lập trình Web](#l%E1%BA%ADp-tr%C3%ACnh-web)
    - [Lập trình Desktop](#l%E1%BA%ADp-tr%C3%ACnh-desktop)
    - [Lập trình Mobile](#l%E1%BA%ADp-tr%C3%ACnh-mobile)
    - [Lập trình Game](#l%E1%BA%ADp-tr%C3%ACnh-game)
- [Tài liệu học theo ngôn ngữ lập trình](#t%C3%A0i-li%E1%BB%87u-h%E1%BB%8Dc-theo-ng%C3%B4n-ng%E1%BB%AF-l%E1%BA%ADp-tr%C3%ACnh)
    - [AutoIt](#autoit)
    - [Bash](#bash)
    - [C/C++](#cc)
    - [Java](#java)
...
- [**Lập trình Web Cơ bản**](./dinh-huong/webdev.md) - *Gợi ý:* HTML, CSS, JavaScript cơ bản, sau đó có thể chọn các framework/thư viện như React, Angular, Vue.js cho Frontend và Node.js, Python (Django/Flask), PHP (Laravel/Symfony), Ruby on Rails cho Backend.

### 🖥️ Lập trình Desktop

Phát triển các ứng dụng chạy trên máy tính cá nhân.

- [**Lập trình Desktop Cơ bản**](./dinh-huong/desktopdev.md) - Gợi ý:* Java (Swing/JavaFX), C# (.NET Windows Forms/WPF), Python (Tkinter/PyQt).

### 📱 Lập trình Mobile

Xây dựng ứng dụng cho các nền tảng di động như Android và iOS.

- [**Trang định hướng**](./dinh-huong/mobiledev.md) - *Gợi ý:* Android (Java/Kotlin), iOS (Swift/Objective-C), Cross-platform (React Native, Flutter, Xamarin).

### 🎮 Lập trình Game

Tạo ra những trải nghiệm giải trí tương tác.

- [**Trang định hướng**](./dinh-huong/gamedev.md) - *Gợi ý:* Unity (C#), Unreal Engine (C++), Godot Engine (GDScript/C#).
